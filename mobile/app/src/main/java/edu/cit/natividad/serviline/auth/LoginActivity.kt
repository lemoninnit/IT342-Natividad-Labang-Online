...
import edu.cit.natividad.serviline.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        binding.btnLogoBack.setOnClickListener {
            val intent = Intent(this@LoginActivity, edu.cit.natividad.serviline.ServiLineApplication::class.java)
