...
import edu.cit.natividad.serviline.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun launchRequestForm(type: String, title: String) {
        val intent = Intent(this, edu.cit.natividad.serviline.requests.RequestFormActivity::class.java).apply {
