...
import edu.cit.natividad.serviline.databinding.ActivityRecordsBinding
...
class RecordsActivity : AppCompatActivity() {
    ...
    private fun updateSummaries(records: List<edu.cit.natividad.serviline.api.models.CertificateRequestResponseDTO>) {
