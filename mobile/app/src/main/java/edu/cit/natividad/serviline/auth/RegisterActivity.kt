package edu.cit.natividad.serviline.auth
...
import edu.cit.natividad.serviline.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnLogoBack.setOnClickListener {
            val intent = Intent(this@RegisterActivity, edu.cit.natividad.serviline.ServiLineApplication::class.java)
    ...
    private fun setupDatePicker() {
        binding.dobInput.setOnClickListener {
            DatePickerDialog(
                this,
                R.style.Theme_ServiLine_DatePicker,
                { _, year, month, day ->
